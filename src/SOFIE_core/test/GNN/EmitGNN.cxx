...
#include "SOFIE/FunctionList.hxx"
...
int main(){
    ...
    func.reset(new RFunction_MLP(FunctionTarget::EDGES, 1, Activation::RELU, 1));
    ...
    func.reset(new RFunction_MLP(FunctionTarget::NODES, 1, Activation::RELU, 1));
    ...
    func.reset(new RFunction_MLP(FunctionTarget::GLOBALS, 1, Activation::RELU, 1));
